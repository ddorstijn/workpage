...
export const Header: Component<Props> = (props) => {
    ...
    return (
        <header>
            <div>
                <button class={styles["header-item"]} onClick={() => projectDialog!.showModal()}>
                    ...
                    <span class="options">Add project</span>
                </button>
                ...
                <button class={styles["header-item"]} onClick={() => groupDialog?.showModal()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor"
                    ...
                    <span class="options">Add group</span>
                </button>
            ...
            <div>
                <button class={styles["header-item"]}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor"
                    ...
                    <span class="options">Translate</span>
                </button>
                <button class={styles["header-item"]}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor"
                    ...
                    <span class="options">Switch themes</span>
                </button>
            </div>
        </header>
    );
