...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			attr_dev(i, "class", "material-icons md-12");
			add_location(i, file, 178, 8, 3886);
			attr_dev(span, "class", "todo-item__due [ hint ] svelte-p9zmcz");
			add_location(span, file, 177, 7, 3839);
		},
		m: function mount(target, anchor) {
...
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(div0, file, 159, 5, 3356);
			attr_dev(span, "class", "todo-item__title line-hover [ no-gutters ] svelte-p9zmcz");
			attr_dev(span, "title", "Mark as done");
			add_location(span, file, 169, 6, 3644);
			add_location(div1, file, 168, 5, 3632);
			attr_dev(button, "class", "task-delete material-icons [ md-14 no-gutters ] [ alert ] svelte-p9zmcz");
			attr_dev(button, "title", "Delete task");
			add_location(button, file, 183, 5, 3991);
			attr_dev(li, "class", "todo-item svelte-p9zmcz");
			add_location(li, file, 158, 4, 3284);
			this.first = li;
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i, file, 210, 3, 4882);
			add_location(span, file, 211, 3, 4926);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(i, "class", "material-icons md-18");
			add_location(i, file, 207, 3, 4799);
			add_location(span, file, 208, 3, 4848);
		},
		m: function mount(target, anchor) {
			insert_dev(target, i, anchor);
			insert_dev(target, t1, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 121, 4, 2465);
			add_location(span, file, 122, 4, 2531);
			attr_dev(label, "class", "svelte-p9zmcz");
			add_location(label, file, 120, 3, 2453);
			attr_dev(button0, "class", "material-icons [ no-gutters ]");
			attr_dev(button0, "type", "button");
			attr_dev(button0, "title", "Add due date");
			add_location(button0, file, 124, 3, 2576);
			attr_dev(input1, "type", "submit");
			input1.hidden = true;
			add_location(input1, file, 142, 3, 2979);
			attr_dev(form, "class", "svelte-p9zmcz");
			add_location(form, file, 119, 2, 2408);
			attr_dev(header, "class", "svelte-p9zmcz");
			add_location(header, file, 118, 1, 2397);
			attr_dev(ul, "class", "todo-wrapper svelte-p9zmcz");
			add_location(ul, file, 145, 1, 3032);
			attr_dev(button1, "class", "task-actions svelte-p9zmcz");
			add_location(button1, file, 205, 1, 4708);
			attr_dev(article, "class", "svelte-p9zmcz");
			add_location(article, file, 117, 0, 2386);
		},
...
//# sourceMappingURL=Tasks-4b505375.js.map
