...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 104, 3, 2307);
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", "Name");
			input0.required = true;
			add_location(input0, file, 108, 6, 2437);
			add_location(span1, file, 109, 6, 2493);
			add_location(label0, file, 107, 5, 2423);
			option.__value = "";
			option.value = option.__value;
			option.disabled = true;
			option.selected = true;
			add_location(option, file, 114, 7, 2571);
			select.required = true;
			add_location(select, file, 113, 6, 2546);
			add_location(span2, file, 119, 6, 2736);
			add_location(label1, file, 112, 5, 2532);
			add_location(fieldset, file, 106, 4, 2407);
			attr_dev(input1, "type", "url");
			attr_dev(input1, "placeholder", "www.example.com");
			input1.required = true;
			add_location(input1, file, 124, 5, 2803);
			add_location(span3, file, 125, 5, 2868);
			add_location(label2, file, 123, 4, 2790);
			attr_dev(button, "type", "button");
			add_location(button, file, 129, 5, 2935);
			attr_dev(input2, "class", "elevation-2");
			attr_dev(input2, "type", "submit");
			input2.value = "Add link";
			add_location(input2, file, 132, 5, 3030);
			attr_dev(div0, "class", "form-actions");
			add_location(div0, file, 128, 4, 2903);
			add_location(form, file, 105, 3, 2361);
			attr_dev(div1, "class", "arrow");
			attr_dev(div1, "data-popper-arrow", "");
			add_location(div1, file, 135, 3, 3116);
			attr_dev(div2, "class", "tooltip [ surface elevation-24 ]");
			add_location(div2, file, 100, 2, 2210);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.value = option.__value;
			add_location(option, file, 116, 8, 2653);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			attr_dev(span0, "class", "caption hint");
			add_location(span0, file, 143, 3, 3293);
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", "Name");
			add_location(input0, file, 146, 5, 3408);
			add_location(span1, file, 147, 5, 3454);
			add_location(label, file, 145, 4, 3395);
			attr_dev(button, "type", "button");
			add_location(button, file, 151, 5, 3523);
			attr_dev(input1, "class", "elevation-2");
			attr_dev(input1, "type", "submit");
			input1.value = "Add group";
			add_location(input1, file, 154, 5, 3619);
			attr_dev(div0, "class", "form-actions");
			add_location(div0, file, 150, 4, 3491);
			add_location(form, file, 144, 3, 3348);
			attr_dev(div1, "class", "arrow");
			attr_dev(div1, "data-popper-arrow", "");
			add_location(div1, file, 157, 3, 3706);
			attr_dev(div2, "class", "tooltip [ surface elevation-24 ]");
			add_location(div2, file, 139, 2, 3195);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, span0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 77, 1, 1710);
			attr_dev(button0, "class", "hint");
			add_location(button0, file, 83, 2, 1917);
			attr_dev(div1, "class", "divider-y");
			add_location(div1, file, 90, 2, 2034);
			attr_dev(button1, "class", "hint");
			add_location(button1, file, 91, 2, 2062);
			attr_dev(div2, "class", "action-buttons svelte-10efutf");
			add_location(div2, file, 82, 1, 1886);
			attr_dev(article, "class", "svelte-10efutf");
			add_location(article, file, 76, 0, 1699);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=Links-7ad6d665.js.map
