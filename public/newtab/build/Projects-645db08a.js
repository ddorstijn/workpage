...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$1, 35, 4, 647);
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$1, 27, 6, 477);
			attr_dev(input1, "type", "submit");
			input1.hidden = true;
			add_location(input1, file$1, 32, 6, 590);
			add_location(form, file$1, 26, 4, 428);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h6, file, 88, 5, 1945);
			attr_dev(button0, "class", "material-icons [ hint no-gutters ]");
			add_location(button0, file, 89, 5, 1981);
			attr_dev(header, "class", "svelte-soirtw");
			add_location(header, file, 87, 4, 1931);
			attr_dev(div0, "class", "modal__body svelte-soirtw");
			add_location(div0, file, 93, 4, 2110);
			add_location(button1, file, 99, 5, 2359);
			attr_dev(div1, "class", "divider-y");
			add_location(div1, file, 102, 5, 2469);
			add_location(button2, file, 103, 5, 2504);
			attr_dev(div2, "class", "action-buttons svelte-soirtw");
			add_location(div2, file, 98, 4, 2325);
			attr_dev(div3, "class", "modal [ surface elevation-1 ] svelte-soirtw");
			add_location(div3, file, 86, 3, 1883);
			attr_dev(div4, "class", "scrim svelte-soirtw");
			add_location(div4, file, 85, 2, 1860);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 110, 6, 2740);
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", "Name");
			input0.required = true;
			add_location(input0, file, 114, 9, 2888);
			add_location(span1, file, 115, 9, 2947);
			add_location(label0, file, 113, 8, 2871);
			option.__value = "";
			option.value = option.__value;
			option.disabled = true;
			option.selected = true;
			add_location(option, file, 119, 10, 3036);
			select.required = true;
			add_location(select, file, 118, 9, 3008);
			add_location(span2, file, 124, 9, 3229);
			add_location(label1, file, 117, 8, 2991);
			add_location(fieldset, file, 112, 7, 2852);
			attr_dev(button, "type", "button");
			add_location(button, file, 129, 8, 3327);
			attr_dev(input1, "class", "elevation-2");
			attr_dev(input1, "type", "submit");
			input1.value = "Add project";
			add_location(input1, file, 132, 8, 3435);
			attr_dev(div0, "class", "form-actions");
			add_location(div0, file, 128, 7, 3292);
			add_location(form, file, 111, 6, 2800);
			attr_dev(div1, "class", "arrow");
			attr_dev(div1, "data-popper-arrow", "");
			add_location(div1, file, 135, 6, 3533);
			attr_dev(div2, "class", "tooltip [ surface elevation-24 ]");
			add_location(div2, file, 109, 5, 2646);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.value = option.__value;
			add_location(option, file, 121, 11, 3131);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			attr_dev(span0, "class", "caption hint");
			add_location(span0, file, 140, 6, 3716);
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", "Name");
			input0.required = true;
			add_location(input0, file, 143, 8, 3843);
			add_location(span1, file, 144, 8, 3901);
			add_location(label, file, 142, 7, 3827);
			attr_dev(button, "type", "button");
			add_location(button, file, 148, 8, 3979);
			attr_dev(input1, "class", "elevation-2");
			attr_dev(input1, "type", "submit");
			input1.value = "Add group";
			add_location(input1, file, 151, 8, 4084);
			attr_dev(div0, "class", "form-actions");
			add_location(div0, file, 147, 7, 3944);
			add_location(form, file, 141, 6, 3777);
			attr_dev(div1, "class", "arrow");
			attr_dev(div1, "data-popper-arrow", "");
			add_location(div1, file, 154, 6, 4180);
			attr_dev(div2, "class", "tooltip [ surface elevation-24 ]");
			add_location(div2, file, 139, 5, 3624);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, span0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i, file, 80, 2, 1775);
			attr_dev(button, "class", "elevation-2");
			add_location(button, file, 79, 1, 1713);
			add_location(article, file, 78, 0, 1702);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=Projects-645db08a.js.map
